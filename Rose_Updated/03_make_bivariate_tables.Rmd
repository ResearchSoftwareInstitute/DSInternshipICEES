...
## Setting up the calls to the OpenAPI
...
## I'm hard coding this for the moment, but I don't like it one bit
var1_values <- univariate_df %>%
  filter(feature == "TotalEDInpatientVisits") %>%
  select(value)

table1_df <- for(i in 1:10) {
  df <-table1_list$feature_matrix[[1]]
  if(i == 1) {
