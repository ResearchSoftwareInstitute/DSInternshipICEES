...
#
ICEES1 <- read.delim(file="response_1560433005911.txt",sep="\t", header = FALSE)
colnames(ICEES1) <- c("Avg24hPM2.5Exposure1", "MajorRoadwayHighwayExposure1", "Frequency1")
#
p1 <- data.frame("Avg24hPM2.5Exposure1" = c(0), "MajorRoadwayHighwayExposure1" = c(0), "Frequency1" = c(0), "low1" = (0), "high1" = (0))
for(i in 1:5){
  t1 <- ICEES1 %>%
